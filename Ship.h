/** @file Ship.h
 *  @brief Ship class declaration.
 *
 *  Ships are generated by the computer. This game can be expanded
 *  to allow two users to choose ship placement; at the moment this
 *  program supports only computer generated ships.
 *
